...
public class Graph {
    ...
    public int findRoot() {
        ...
        // Initialize an array to store in-degrees
        ...
        for (int i = 0; i < numVertices; i++) {
            if (inDegrees[i] == 0) {
                ...
                // If more than one root vertex exists, return -1
                if (rootCount > 1) {
                    return -1;
                }
            }
        ...
        // If exactly one root vertex is found, return its value
        // Otherwise, return -1 if no root exists
